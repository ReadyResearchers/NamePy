...
# TODO: Create flag to print jsons
...
class IdentifierVisitor(cst.CSTVisitor):
    ...
    # def handle_assign_lookup(self, var_name:str, location:tuple(int, int)):
    #     pass
    ...
    def visit_Assign(self, node: cst.Assign) -> None:
        ...
        #         pass
        #     elif isinstance(assign_target, cst.Tuple):
        #         assign_elements = assign_target.elements
        #         # var1, var2, var3
        #         for element in assign_elements:
        #             lookup = element.value.value
        #     else:
        #         # throw error or ignore it
        #         pass
        for target in node.targets:
            assign_target = target.target
...
# TODO: Check if i redid json stuff right
